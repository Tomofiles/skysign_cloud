...
import (
	...
	mavsdk_rpc_action "edge/protos/action"
	mavsdk_rpc_core "edge/protos/core"
	mavsdk_rpc_mission "edge/protos/mission"
	mavsdk_rpc_telemetry "edge/protos/telemetry"
)
...
func NewMavlink(ws *websocket.Conn, gr *grpc.ClientConn) *Mavlink {
	return &Mavlink{Ws: ws, Gr: gr}
}

// SendTelemetry method
func (mavlink *Mavlink) SendTelemetry() {
	...
	for {
		...
		posdata := Telemetry{
			VehicleID: strconv.FormatUint(mavlink.VehicleID, 10),
			Position: &Position{
